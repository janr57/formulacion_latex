...
\begin{tabular}{|c|c|}\hline
  ...
  \phantom{\rule{0.4pt}{2.5ex}}
  \texttt{\{CH\_3-CH\textcolor{\standoutColor}{(-[2]CH\_3)}-CH\_3\}}
  & \texttt{\{CH\_3-[2]CH\textcolor{\standoutColor}{(-[4]CH\_3)}-CH\_3\}}\\
  \hline
\end{tabular}
...
\begin{tabular}{|c|c|}\hline
  ...
  & \texttt{[bond join]}\\
  \phantom{\rule{0.4pt}{2.5ex}}
  \texttt{\{CH\_3-[7]CH(-[5]CH\_3)-CH\_3\}}
  & \texttt{\{-[7](-[5])-\}}\\
  \hline
\end{tabular}
...
\begin{tabular}{|c|}\hline
  ...
  \phantom{\rule{0.4pt}{3ex}}
  \texttt{[bond join]}\\
  \texttt{\{-[7]CH\_3(-[5]CH\_3)-CH\_3\}}\\
  \hline
\end{tabular}

\subsubsection{Ácido acético o etanoico}
\begin{tabular}{|c|c|}\hline
  \phantom{\rule{0.4pt}{7ex}}
  \chemfig{CH_3-COOH}
...
\begin{tabular}{|c|}\hline
  ...
  \phantom{\rule{0.4pt}{3ex}}
  \texttt{\small%
  \{H-[\textcolor{\standoutColor}{:0}]  C(-[::90]H)(-[::-90]H)-[::0]C(=[::45]O)-[::-45]O-[::45]H\}
  }
  \\\hline
\end{tabular}
...
\begin{tabular}{|c|}\hline
  \phantom{\rule{0.4pt}{13.5ex}}
  \chemfig{H-[:45]C(-[::90]H)(-[::-90]H)-[::0]C(=[::45]O)(-[::-45]O(-[::45]H))}\\
\texttt{\small\{H-[\textcolor{\standoutColor}{:45}]C(-[::90]H)(-[::-90]H)-[::0]C(=[::45]O)(-[::-45]O(-[::45]H))\}}\\
  \hline
\end{tabular}

\subsubsection{Anhídrido acético}
En el siguiente ejemplo, las longitudes de enlace quedan algo diferentes:

\begin{tabular}{|c|}\hline
  \phantom{\rule{0.4pt}{ex}}
  \chemfig{CH_3-CO-O-CO-CH_3}\\
  \phantom{\rule{0.4pt}{1ex}}
  \texttt{%2
  \{CH\_3-CO-O-CO-CH\_3\}
  }
  \\\hline
...
\begin{tabular}{|c|}\hline
  ...
  \phantom{\rule{0.4pt}{3ex}}
  \texttt{%
  \{CH\_3-C(=[1]O)-[7]O-[5]C(=[7]O)-[4]CH\_3\}
  }
  \\\hline
\end{tabular}
...
\subsubsection{Otras cadenas ramificadas}
\begin{tabular}{|c|}\hline
  \phantom{\rule{0.4pt}{7ex}}
  \chemfig{CH_2=C(-[2]CH_2-CH_3)-CH(-[6]CH(-[6]CH_3)-CH_3)-CH=CH-CH_3}\\
  \phantom{\rule{0.4pt}{3ex}}
  \texttt{%
  \{CH\_2=C(-[2]CH\_2-CH\_3)-CH(-[6]CH(-[6]CH\_3)-CH\_3)-CH=CH-CH\_3\}
  }
  \\\hline
\end{tabular}


\subsubsection{Isomería geométrica \emph{cis-trans}: 2-hexeno}
...
\begin{tabular}{|c|}\hline
  ...
  \phantom{\rule{0.4pt}{3ex}}
  \texttt{\{CH\_3CH\_2-[7]C(-[5]H)=C(-[7]H)-[1]CH\_2CH\_3\}}\\
  \hline
\end{tabular}
