...
\subsection{Efecto del primer átomo en la línea base}
...
\begin{tabular}{|l|}\hline
  \phantom{\rule{0.4pt}{2ex}}
  \phantom{\chemfig{A-B}}\hspace{-2.5em}\tikz \draw[help lines, red,] (0,0) -- (5em,0);
...
\subsubsection{\emph{Isobutano} o metilpropano}
Observa que las dos fórmulas tienen la misma altura porque utilizan la misma línea base, dado que utilizan el mismo átomo \ce{C} en primer lugar. Se han señalado en negrita
los átomos de carbono de la cadena base utilizada, y en la sección de código se ha
señalado la ramificación en rojo:

\begin{tabular}{|c|c|}\hline
  \phantom{\rule{0.4pt}{7ex}}
  \chemfig{\textbf{C}H_3-\textbf{C}H(-[2]CH_3)-\textbf{C}H_3}
  & \chemfig{\textbf{C}H_3-CH(-[6]CH_3)-CH_3}\\
  \texttt{\{CH\_3-CH\textcolor{\standoutColor}{(-[2]CH\_3)}-CH\_3\}}
  & \texttt{\{CH\_3-CH\textcolor{\standoutColor}{(-[2]CH\_3)}-CH\_3\}}\\
  \hline
\end{tabular}

\vspace{1ex}
En este caso, también se han señalado en negrita los átomos de carbono que forman la
cadena base utilizada. En la sección de código se marca en rojo la ramificación.
...
\begin{tabular}{|c|c|}\hline
  ...
  \texttt{\{CH\_3-[6]CH\textcolor{\standoutColor}{(-[4]CH\_3)}-CH\_3\}}
  & \texttt{\{CH\_3-CH\textcolor{\standoutColor}{(-[6]CH\_3)}-CH\_3\}}\\
  \hline
\end{tabular}
...
de la línea base. Seguimos señalando en negrita los carbonos de la cadena base utilizada
y en la línea de código, en rojo, la ramificación:
...
\begin{tabular}{|c|c|}\hline
  ...
  \phantom{\rule{0.4pt}{2.5ex}}
  \texttt{%
  \{CH\_3-CH\textcolor{\standoutColor}{(-[2]CH\_3)}-CH\_3\}
  }
  & \texttt{%
    \{CH\_3-[2]CH\textcolor{\standoutColor}{(-[4]CH\_3)}-CH\_3\}
    }
  \\\hline
\end{tabular}

\vspace{1ex}
A partir de ahora no señalaremos en negrita los carbonos que forman la línea base, ni
la ramificación en rojo en la línea de código.
