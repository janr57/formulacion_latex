...
\section{Ejemplo de configuración de \textsf{chemfig} por defecto}
...
\section{Ejemplos de ramificaciones en cadenas abiertas}
...
\subsection{Otras cadenas ramificadas: 2-etil-3-isopropil-1,4-hexadiento}

\begin{tabular}{|c|}\hline
  \phantom{\rule{0.4pt}{7ex}}
  \chemfig[atom sep=1.1em,fixed length=true]  {CH_2=C(-[2]CH_2-CH_3)-CH(-[6]CH(-[6]CH_3)-CH_3)-CH=CH-CH_3}\\
  \phantom{\rule{0.4pt}{3ex}}
  \texttt{[atom sep=1.1em,fixed length]}\\
  \texttt{%
...
\subsection{Isomería geométrica \emph{cis-trans}: 2-hexeno}
